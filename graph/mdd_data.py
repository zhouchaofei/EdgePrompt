...
def load_mdd_data(data_folder='./data', graph_method='correlation_matrix'):
    ...
    # 检查是否存在双流数据
    dual_stream_path = os.path.join(data_folder, 'REST-meta-MDD/processed/mdd_dual_stream_temporal_150.pt')
...
if __name__ == "__main__":
    ...
    if choice == '1':
        # 生成双流数据
        from mdd_data import prepare_all_data
